    ...
    override fun onBindViewHolder(holder: DogViewHolder, position: Int) {
        ...
        holder.binding.dogImageView.setOnClickListener {
            if (position != RecyclerView.NO_POSITION) {
                ...
                bundle.putString("argImageUrl", dog.toString())

                findNavController(holder.itemView.findFragment()).navigate(R.id.action_FirstFragment_to_SecondFragment, bundle)
            }
        }
    }
